...
<tr><td>order_type</td><td>The NPOR order type (e.g. PRO, SUP, RRH)</td><td>String</td></tr>
<tr><td>numbers</td><td>Array of associated/other numbers in the export request. Each entry contains <code>type</code> (associated or other) and <code>number</code></td><td>Array</td></tr>
...
```json
{
  ...
  "data": {
    ...
    "order_type": "PRO",
    "numbers": [
      { "type": "associated", "number": "442033456790" },
      { "type": "associated", "number": "442033456791" },
      { "type": "other", "number": "447700900123" }
    ],
...
<tr><td>rejected</td><td>Export has been rejected by the customer. reason and code will contain the rejection details where available</td></tr>
<tr><td>irrelevant</td><td>Export request has been marked as not relevant</td></tr>
<tr><td>cancel_other</td><td>Export has been cancelled by the other party (COT - Cancel Other)</td></tr>
