...
<tr>
<td><b>ANY   <t /> </b></td>
<td><t /> Returns human-readable report of the request receive
<br />
...
Returns the current level of alert. <br/>
...
Sets the alert balance to the specified alert_balance <br/>
...
<td>
Update channel limits <br />
<tr>
<td>JSON request</td>
<tr><td>limit_concurrent_in</td><td>inbound channel Limit</td></tr>
<tr><td>limit_concurrent_out</td><td>outbound channel Limit</td></tr>
<tr><td>NB the above must, together, total the value of channel_allocation</td></tr>
<tr>
...
<td>
<tr>
<td>Recent (around 24h) channel utilisation samples
The channels count shows the peak number of channels in use between the previous datetime timestamp and the current one.</td>
</tr>
<tr> <td>interval<br/>
Optional interval for samples in the following form;
<br /><b>1m</b> - One Minute
<br/><b>5m</b> - Five Minutes(Default)
<br/><b>1h</b> - Hourly</td></tr>
<tr>
<td>
...
<td>
<tr>
<td>Number and value of calls in progress relative to account balance. Useful for fraud monitoring.</td>
</tr>
...
<tr>
<td>GET</td>
<td> <tr>Get information on current call in progress</tr>
...
<tr>
<td>DELETE</td>
<td> <tr>End a call in progress</tr>
...
<tr>
<td><b>GET</b></td>
<td> Get all available recently rejected calls
<tr>
...
<td><b>POST</b></td>
<td>
Request and return a new password for this trunk.<br/>
<b>NB The old password will be disabled immediately, any devices configured to use this trunk will need reconfigured to continue to make outbound calls.</b>
<tr>
...
|:-|:-|
|**GET**|Return the currently associated numbers  <br />  { "success": true, "data": [ "443301223000", "443301223001", "443301223002", ... ] }|
|**PUT**|Associate more numbers to the trunk, passing the numbers you wish to append as an array, per the example below <br /> { "data": [ "443301223003", "443301223004", "443301223005", ... ] }|
| **POST** | Replace the list of associated numbers entirely, passing the numbers you wish to replace it with as an array. Passing an empty array will remove any direct associations with this trunk. <br /> **NB** All existing associations with this trunk will be removed! <br /> {  “data”: [ “443301223100”, “443301223101”, “443301223102”, ... ]} | 
...
<td><b>GET</b></td>
<td>
etrieves a list of all available UK number ranges, including descriptions. This is intended for customers to populate, for example, a drop down to allow customers to select an area <br />
<b>NB</b> This does not return international numbering at this time.
...
<td><b>GET</b></td>
<td>
Returns a JSON object describing the most recent call to this number
<tr>
...
<td>Rules define times of day that routing blocks (below) apply, outwith the rules given -
 or if the rules section is omitted entirely - the <b>default</b> routing block will be used.</td>
</tr>
...
<td>This block will run during the <b>officehours</b> time block defined above (Mon-Fri 9am-5pm) 
...
<td>After the timeout above (30s) we will try the PSTN number provided</td>
</tr>
...
<td>The <b>default</b> routing block will be used outwith the office hours specified above. 
...
<td>Per number configuration options (detailed above) apply to the number at all times</td>
</tr>
...
<td>The <b>meta</b> block contains arbitrary metadata that you want to associate with the number </td>
</tr>
</table>
