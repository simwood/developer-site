...
The [Sipcentric PBX](https://www.nimvelo.com/nimvelo-phone/) is a cloud-based service which enables businesses of all shapes and sizes to create a fully-featured, virtual PBX in minutes - allowing them to scale up or down instantly as their needs change and without commitment.
...
As a basic example of what can be achieved, we have developed the [Chrome Extension](https://www.nimvelo.com/nimvelo-voip-phone/integrations-voip/), available in the [Chrome Web Store](https://chromewebstore.google.com/detail/nimvelo-for-chrome/kpiopepamhnnileoefikeakookcblmpc). The code is also available on [GitHub](https://github.com/Nimvelo/chrome-extension).

## Getting Started

Before you can begin using the API, you'll need a Sipcentric PBX account. If you don't have one already, [create your account here](https://my.nimvelo.com/signup) - it's free to get started and only takes a minute.
