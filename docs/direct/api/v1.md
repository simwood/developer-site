...
In order to run stream the authenticating user should be an admin in that particular account. 

example below should work 
```bash 

curl -X GET -u "user:pass" --no-buffer "https://pbx.sipcentric.com/api/v1/stream"
