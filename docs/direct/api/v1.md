...
<Tabs>
  <TabItem value="json" label="Example Request">
...
```json
{
  "type": "customer",
  "id": "99999",
  "uri": "https://pbx.sipcentric.com/api/v1/customers/999999",
  "created": "2023-05-24T11:18:36Z",
  "accountType": "BUSINESS",
  "company": "Sipcentric",
  "firstName": "Test",
  "lastName": "User",
  "telephone": "03301201200",
  "email": "Test@test.com",
...
| id <br /> *required*         | The unique customer id ("5"). <br /> *String*                                  |
...

{
  ...
  "currency": "GBP",
  "links": {
    "outgoingCallerIds": "https://pbx.sipcentric.com/api/v1/customers/99999/outgoingcallerids",
    "endpoints": "https://pbx.sipcentric.com/api/v1/customers/99999/endpoints",
    "preferences": "https://pbx.sipcentric.com/api/v1/customers/99999/preferences",
    "timeIntervals": "https://pbx.sipcentric.com/api/v1/customers/99999/timeintervals",
    "creditStatus": "https://pbx.sipcentric.com/api/v1/customers/99999/creditstatus",
    "phoneNumbers": "https://pbx.sipcentric.com/api/v1/customers/99999/phonenumbers",
    "bargeGroups": "https://pbx.sipcentric.com/api/v1/customers/99999/bargegroups",
    "callBundles": "https://pbx.sipcentric.com/api/v1/customers/99999/callbundles",
    "linkedUsers": "https://pbx.sipcentric.com/api/v1/customers/99999/linkedusers",
    "sounds": "https://pbx.sipcentric.com/api/v1/customers/99999/sounds",
    "phoneBook": "https://pbx.sipcentric.com/api/v1/customers/99999/phonebook",
    "calls": "https://pbx.sipcentric.com/api/v1/customers/99999/calls",
    "recordings": "https://pbx.sipcentric.com/api/v1/customers/99999/recordings",
    "sms": "https://pbx.sipcentric.com/api/v1/customers/99999/sms"
  },
  "partnerId": "999",
  "partnerCompany": "Test Partner",
  "userEmailUpdatable": false
...
```
POST https://pbx.sipcentric.com/api/v1/customers
```
...
```json
{
  "type": "phonebookentry",
  "id": "84033",
  "uri": "https://pbx.sipcentric.com/api/v1/customers/99999/phonebook/84033",
  "parent": "https://pbx.sipcentric.com/api/v1/customers/99999",
...
```
GET https://pbx.sipcentric.com/api/v1/customers/99999/phonebook?pageSize=2&page=1
```
...

{
  ...
  "items": [
    {
      ...
      "type": "phonebookentry",
      "id": "84039",
      "uri": "https://pbx.sipcentric.com/api/v1/customers/99999/phonebook/84039",
      "parent": "https://pbx.sipcentric.com/api/v1/customers/99999",
  ...
  "nextPage": "https://pbx.sipcentric.com/api/v1/customers/99999/phonebook?pageSize=2&page=2"
}
```
 </TabItem>
</Tabs>
...
```
GET https://pbx.sipcentric.com/api/v1/customers/99999/phonebook/773
```
...
```
POST https://pbx.sipcentric.com/api/v1/customers/99999/phonebook
```
...

{
  "type": "phonebookentry",
  "id": "84072",
  "uri": "https://pbx.sipcentric.com/api/v1/customers/99999/phonebook/84072",
  "parent": "https://pbx.sipcentric.com/api/v1/customers/99999",
...
```
PUT https://pbx.sipcentric.com/api/v1/customers/99999/phonebook/716
```
...
{
  "type": "phonebookentry",
  "uri": "http://pbx.sipcentric.com/api/v1/customers/99999/phonebook/716",
...
```
DELETE https://pbx.sipcentric.com/api/v1/customers/99999/phonebook/716
```
...
```json
{
  "type": "smsmessage",
  "id": "31408968",
  "uri": "https://pbx.sipcentric.com/api/v1/customers/99999/sms/31408968",
  "parent": "https://pbx.sipcentric.com/api/v1/customers/99999",
...
```
GET https://pbx.sipcentric.com/api/v1/customers/99999/sms?pageSize=2&page=1
```
...
HTTP/1.1 200 OK
{
  ...
  "items": [
    {
      "type": "smsmessage",
      "id": "31414341",
      "uri": "https://pbx.sipcentric.com/api/v1/customers/99999/sms/31414341",
      "parent": "https://pbx.sipcentric.com/api/v1/customers/99999",
      ...
      "type": "smsmessage",
      "id": "31414338",
      "uri": "https://pbx.sipcentric.com/api/v1/customers/99999/sms/31414338",
      "parent": "https://pbx.sipcentric.com/api/v1/customers/99999",
  ...
  "nextPage": "https://pbx.sipcentric.com/api/v1/customers/99999/sms/?createdBefore=2023-05-05T10:51:13Z&pageSize=2&page=2"
}
```
 </TabItem>
</Tabs>
...
```
GET https://pbx.sipcentric.com/api/v1/customers/99999/sms/999993368
```
...
```
POST https://pbx.sipcentric.com/api/v1/customers/99999/sms
```
...
```json
{
  "type": "call",
  "id": "209925287",
  "uri": "https://pbx.sipcentric.com/api/v1/customers/99999/calls/209925287",
  "parent": "https://pbx.sipcentric.com/api/v1/customers/99999",
  ...
  "srcEndpoint": "https://pbx.sipcentric.com/api/v1/customers/99999/endpoints/83069",
  "final": true,
  "links": {
    "recordings": "https://pbx.sipcentric.com/api/v1/customers/99999/recordings?linkedId=366e05e5-1680699535.1182575"
  }
}
```
...
```
GET https://pbx.sipcentric.com/api/v1/customers/99999/calls?createdAfter=2014-03-10T13:30:00Z&pageSize=2&page=1
```
  ...
  "items": [
    {
      "type": "call",
      "id": "7592432",
      "uri": "https://pbx.sipcentric.com/api/v1/customers/99999/calls/7592432",
      "parent": "https://pbx.sipcentric.com/api/v1/customers/99999",
      ...
      "links": {
        "recordings": "https://pbx.sipcentric.com/api/v1/customers/99999/recordings?linkedId=ast01-1400142051.1562723"
      }
    },{
      "type": "call",
      "id": "7592434",
      "uri": "https://pbx.sipcentric.com/api/v1/customers/99999/calls/7592434",
      "parent": "https://pbx.sipcentric.com/api/v1/customers/99999",
      ...
      "links": {
        "recordings": "https://pbx.sipcentric.com/api/v1/customers/99999/recordings?linkedId=ast01-1401721105.2847099"
      }
    }
  ],
  "nextPage": "https://pbx.sipcentric.com/api/v1/customers/99999/calls?pageSize=2&page=2"
}
```
 </TabItem>
</Tabs>
...
```
POST https://pbx.sipcentric.com/api/v1/customers/99999/calls
```

```json
{
  "type": "call",
  "endpoint": "https://pbx.sipcentric.com/api/v1/customers/99999/endpoints/1234",
  "to": "012345678901"
}
```
...
```
GET https://pbx.sipcentric.com/api/v1/customers/99999/sounds?pageSize=2&page=1
```
...

{
  ...
  "items": [
    {
      "type": "prompt",
      "id": "1046",
      "uri": "https://pbx.sipcentric.com/api/v1/customers/99999/sounds/1046",
      "parent": "https://pbx.sipcentric.com/api/v1/customers/99999",
      ...
      "type": "prompt",
      "id": "1035",
      "uri": "https://pbx.sipcentric.com/api/v1/customers/99999/sounds/1035",
      "parent": "https://pbx.sipcentric.com/api/v1/customers/99999",
  ...
  "nextPage": "https://pbx.sipcentric.com/api/v1/customers/99999/sounds?pageSize=2&page=2"
}
```
 </TabItem>
</Tabs>
...
```
GET https://pbx.sipcentric.com/api/v1/customers/99999/sounds/1035
```
...
```json
{
  "type": "recording",
  "id": "1358371",
  "uri": "https://pbx.sipcentric.com/api/v1/customers/99999/recordings/1358371",
  "parent": "https://pbx.sipcentric.com/api/v1/customers/99999",
  "created": "2014-03-10T13:37:00.000+0000",
  "direction": "IN",
  "partyId": "106",
  ...
  "endpoint": "https://pbx.sipcentric.com/api/v1/customers/99999/endpoints/9999935"
}
```
...
```
GET https://pbx.sipcentric.com/api/v1/customers/99999/recordings?pageSize=2&page=1
```
...

{
  ...
  "items": [
    {
      "type": "recording",
      "id": "1358372",
      "uri": "https://pbx.sipcentric.com/api/v1/customers/99999/recordings/1358372",
      "parent": "https://pbx.sipcentric.com/api/v1/customers/99999",
      ...
      "callId": "ast01-1401721105.2847099",
      "linkedId": "ast01-1401721105.2847099",
      "endpoint": "https://pbx.sipcentric.com/api/v1/customers/99999/endpoints/1928"
    },{
      "type": "recording",
      "id": "1358371",
      "uri": "https://pbx.sipcentric.com/api/v1/customers/99999/recordings/1358371",
  ...
  "nextPage": "https://pbx.sipcentric.com/api/v1/customers/99999/recordings?pageSize=2&page=2"
}
```
...
```
GET https://pbx.sipcentric.com/api/v1/customers/99999/recordings/1358371
```
...
```json
{
  "type": "timeinterval",
  "id": "431",
  "uri": "https://pbx.sipcentric.com/api/v1/customers/99999/timeintervals/431",
  "parent": "https://pbx.sipcentric.com/api/v1/customers/99999",
  "created": "2014-03-10T13:37:00.000+0000",
  "name": "Lunchtimes",
  "repeat": "WEEKLY",
...
```
GET https://pbx.sipcentric.com/api/v1/customers/99999/timeintervals?pageSize=2&page=1
```
...

{
  ...
  "items": [
    {
      "type": "timeinterval",
      "id": "32",
      "uri": "https://pbx.sipcentric.com/api/v1/customers/99999/timeintervals/32",
      "parent": "https://pbx.sipcentric.com/api/v1/customers/99999",
      "created": "2014-03-10T13:37:00.000+0000",
      "name": "Christmas Day",
      "repeat": "YEARLY",
      ...
      "type": "timeinterval",
      "id": "8675",
      "uri": "https://pbx.sipcentric.com/api/v1/customers/99999/timeintervals/31",
      "parent": "https://pbx.sipcentric.com/api/v1/customers/99999",
  ...
  "nextPage": "https://pbx.sipcentric.com/api/v1/customers/99999/timeintervals?pageSize=2&page=2"
}
```
 </TabItem>
</Tabs>
...
```
GET https://pbx.sipcentric.com/api/v1/customers/99999/timeintervals/431
```
...
```
GET https://pbx.sipcentric.com/api/v1/customers/99999/endpoints?pageSize=2&page=1
```
...

{
  ...
  "items":  [
    {
      "type": "ivr",
      "id": "83066",
      "uri": "https://pbx.sipcentric.com/api/v1/customers/99999/endpoints/102",
      "parent": "https://pbx.sipcentric.com/api/v1/customers/99999",
      "created": "2014-03-10T13:38:00.000+0000",
      "shortNumber": "001",
      "name": "Main IVR",
    ...
    },
    {
      "type": "phone",
      "id": "101",
      "uri": "https://pbx.sipcentric.com/api/v1/customers/99999/endpoints/101",
      "parent": "https://pbx.sipcentric.com/api/v1/customers/99999",
      "created": "2014-03-10T13:37:00.000+0000",
      "shortNumber": "102",
      "name": "John Simmonds",
  ...
  "nextPage": "https://pbx.sipcentric.com/api/v1/customers/99999/endpoints?pageSize=1&page=2"
}
```
 </TabItem>
</Tabs>
...
```
GET https://pbx.sipcentric.com/api/v1/customers/99999/endpoints/101
```
...

{
  ...
  "voicemailEnabled": true,
  "links": {
    "sip": "http://pbx.sipcentric.com/api/v1/customers/99999/endpoints/101/sip",
    "voicemail": "http://pbx.sipcentric.com/api/v1/customers/99999/endpoints/101/voicemail"
  }  
}
```
 </TabItem>
  ...
  "items": [
    {
      "type": "phone",
      "id": "83069",
      "uri": "https://pbx.sipcentric.com/api/v1/customers/99999/endpoints/83069",
      "parent": "https://pbx.sipcentric.com/api/v1/customers/99999",
      ...
      "callWaiting": false,
      "callRecording": "OFF",
      "defaultCallerId": "https://pbx.sipcentric.com/api/v1/customers/99999/outgoingcallerids/49610",
      "voicemailSettings": {
        "autoAnswer": false,
        "pin": "0000",
        "playEnvelope": false,
      ...
      "links": {
        "sip": "https://pbx.sipcentric.com/api/v1/customers/99999/endpoints/83069/sip",
        "forwardingRules": "https://pbx.sipcentric.com/api/v1/customers/99999/endpoints/83069/forwardingrules",
        "status": "https://pbx.sipcentric.com/api/v1/customers/99999/endpoints/83069/phonestatus"
      }
    },{
      "type": "phone",
      "id": "89937",
      "uri": "https://pbx.sipcentric.com/api/v1/customers/99999/endpoints/89937",
      "parent": "https://pbx.sipcentric.com/api/v1/customers/99999",
      ...
      "links": {
        "sip": "https://pbx.sipcentric.com/api/v1/customers/99999/endpoints/89937/sip",
        "forwardingRules": "https://pbx.sipcentric.com/api/v1/customers/99999/endpoints/89937/forwardingrules",
        "status": "https://pbx.sipcentric.com/api/v1/customers/99999/endpoints/89937/phonestatus"
      }
    }
  ]
}
...
```
PUT https://pbx.sipcentric.com/api/v1/customers/99999/endpoints/83066
```
...

{
    "type": "ivr",
    "id": "83066",
    "uri": "https://pbx.sipcentric.com/api/v1/customers/99999/endpoints/83066",
    "parent": "https://pbx.sipcentric.com/api/v1/customers/99999",
...
```
DELETE https://pbx.sipcentric.com/api/v1/customers/99999/endpoints/83066
```
...
```json
{
  "type": "did",
  "id": "50",
  "uri": "https://pbx.sipcentric.com/api/v1/customers/99999/phonenumbers/50",
  "parent": "https://pbx.sipcentric.com/api/v1/customers/99999",
  "created": "2014-03-10T13:37:00.000+0000",
  "number": "01212854400",
  "identifier": "",
  "destination": "https://pbx.sipcentric.com/api/v1/customers/99999/endpoints/101",
  "smsEnabled": true,
  ...
  "routingRules": [
    {
      "timeInterval": "https://pbx.sipcentric.com/api/v1/customers/99999/timeintervals/594",
      "destination": "https://pbx.sipcentric.com/api/v1/customers/99999/endpoints/102"
    },{
      "timeInterval": "https://pbx.sipcentric.com/api/v1/customers/99999/timeintervals/625",
      "destination": "https://pbx.sipcentric.com/api/v1/customers/99999/endpoints/102"
    },{
      "timeInterval": "https://pbx.sipcentric.com/api/v1/customers/99999/timeintervals/704",
      "destination": "https://pbx.sipcentric.com/api/v1/customers/99999/endpoints/102"
    }
  ]
}
...
```
GET https://pbx.sipcentric.com/api/v1/customers/99999/phonenumbers?pageSize=2&page=1
```
...

{
  ...
  "items": [
    {
      "type": "did",
      "id": "47",
      "uri": "https://pbx.sipcentric.com/api/v1/customers/99999/phonenumbers/47",
      "parent": "https://pbx.sipcentric.com/api/v1/customers/99999",
      "created": "2014-03-10T13:37:00.000+0000",
      "number": "01212854400",
      "identifier": "Main",
  ...
  "nextPage": "https://pbx.sipcentric.com/api/v1/customers/99999/phonenumbers?pageSize=2&page=2"
}
```
 </TabItem>
</Tabs>
...
```
GET https://pbx.sipcentric.com/api/v1/customers/99999/phonenumbers/47
```
...
```
POST   https://pbx.sipcentric.com/api/v1/customers/99999/phonenumbers
```
...

{
  "type": "did",
  "id": "94854",
  "uri": "https://pbx.sipcentric.com/api/v1/customers/99999/phonenumbers/94854",
  "parent": "https://pbx.sipcentric.com/api/v1/customers/99999",
  ...
  "faxEnabled": false,
  "links": {
    "routingRules": "https://pbx.sipcentric.com/api/v1/customers/99999/phonenumbers/94854/routingrules"
  }
}
```
 </TabItem>
...
```json
{
  "type": "did",
  "id": "73224",
  "uri": "https://pbx.sipcentric.com/api/v1/customers/99999/phonenumbers/{phonenumberId}",
  "parent": "https://pbx.sipcentric.com/api/v1/customers/99999",
  ...
  "faxEnabled": false,
  "links": {
    "routingRules": "https://pbx.sipcentric.com/api/v1/customers/99999/phonenumbers/{phonenumberId}/routingrules"
  },
  "destination":"89937"
}
```
...

{
    ...
    "number": "01134037921",
    "formatted": "0113 403 7921",
    "destination": "https://pbx.sipcentric.com/api/v1/customers/99999/endpoints/89937",
    "smsCapable": false,
    "faxEnabled": false,
    "links": {
        "routingRules": "https://pbx.sipcentric.com/api/v1/customers/99999/phonenumbers/94854/routingrules"
...
```
PUT   https://pbx.sipcentric.com/api/v1/customers/99999/phonenumbers/94854
```
...
Example
```
DELETE https://pbx.sipcentric.com/api/v1/customers/99999/phonenumbers/94854
```
...
```json
{
  ...
  "id": "114",
  "uri": "https://pbx.sipcentric.com/api/v1/customers/99999/outgoingcallerids/114",
  "parent": "https://pbx.sipcentric.com/api/v1/customers/99999",
  "created": "2014-03-10T13:37:00.000+0000",
  "number": "07932000000",
  "allowCalls": false,
...
```
GET https://pbx.sipcentric.com/api/v1/customers/99999/outgoingcallerids
```
  ...
  "items":  [
    {
      "type": "outgoingcallerid",
      "id": "115",
      "uri": "https://pbx.sipcentric.com/api/v1/customers/99999/outgoingcallerids/115",
      "parent": "https://pbx.sipcentric.com/api/v1/customers/99999",
      "created": "2014-03-10T13:37:00.000+0000",
      "number": "Sipcentric",
      "allowCalls": false,
...
```
GET https://pbx.sipcentric.com/api/v1/customers/99999/outgoingcallerids/114
```
...
{
  "type": "creditstatus",
  "uri": "https://pbx.sipcentric.com/api/v1/customers/99999/creditstatus",
  "uri": "https://pbx.sipcentric.com/api/v1/customers/99999",
  "accountType": "PREPAID",
...
```
GET https://pbx.sipcentric.com/api/v1/customers/99999/creditstatus
```
...
```json
{
  "type": "customerbundle",
  "id": "1040",
  "uri": "https://pbx.sipcentric.com/api/v1/customers/99999/callbundles/1040",
  "parent": "https://pbx.sipcentric.com/api/v1/customers/99999",
...
```
GET https://pbx.sipcentric.com/api/v1/customers/99999/callbundles
```
...
```
GET https://pbx.sipcentric.com/api/v1/customers/99999/callbundles/1040
```
...

{
  "type": "customerbundle",
  "id": "999999",
  "uri": "https://pbx.sipcentric.com/api/v1/customers/99999/callbundles/999999",
  "parent": "https://pbx.sipcentric.com/api/v1/customers/99999",
  "created": "2014-03-01T00:00:00.000+0000",
...
```json
{
  ...
  "id": "99999",
  "uri": "https://pbx.sipcentric.com/api/v1/customers/999999/callcharging",
  "parent": "https://pbx.sipcentric.com/api/v1/customers/9999999",
  "chargingPlan": "https://pbx.sipcentric.com/api/v1/chargingplans/999999",
  "postpaid": true,
  "creditLimit": 50.00,
...
```
GET https://pbx.sipcentric.com/api/v1/customers/99999/callcharging
```
...

{
  "type": "customercallcharging",
  "id": "999999",
  "uri": "https://pbx.sipcentric.com/api/v1/customers/99999/callcharging",
  "parent": "https://pbx.sipcentric.com/api/v1/customers/99999",
  "chargingPlan": "https://pbx.sipcentric.com/api/v1/chargingplans/999999",
  "postpaid": true,
  "creditLimit": 50.00,
...
```
PUT https://pbx.sipcentric.com/api/v1/customers/99999/callcharging
```
...

{
  ...
  "id": "99999",
  "uri": "https://pbx.sipcentric.com/api/v1/customers/999999/callcharging",
  "parent": "https://pbx.sipcentric.com/api/v1/customers/999999",
  "chargingPlan": "https://pbx.sipcentric.com/api/v1/chargingplans/999999",
  "postpaid": true,
  "creditLimit": 50.00,
  "warningThreshold": 0.00
...
```json
{
  ...
  "id": "99999",
  "uri": "https://pbx.sipcentric.com/api/v1/customers/99999/permissions",
  "parent": "https://pbx.sipcentric.com/api/v1/customers/99999",
  "incomingCalls": true,
  "outgoingCalls": true,
...
```
GET https://pbx.sipcentric.com/api/v1/customers/99999/permissions
```
...
{
  "type": "billingaccount",
  "uri": "https://pbx.sipcentric.com/api/v1/customers/99999/billing",
  "parent": "https://pbx.sipcentric.com/api/v1/customers/99999",
  ...
  "links": {
    "invoices": "https://pbx.sipcentric.com/api/v1/customers/99999/billing/invoices",
    "paymentMethods": "https://pbx.sipcentric.com/api/v1/customers/99999/billing/paymentmethods",
    "estimate": "https://pbx.sipcentric.com/api/v1/customers/99999/billing/estimate"
  }
}
```
...
```
GET https://pbx.sipcentric.com/api/v1/customers/99999/billing
```
...
| unitPrice <br /> *read-only*   | Unit price of resource. <br /> *float*                      |
| quantity <br /> *read-only*    | Number of resources.  <br /> *integer*                      |
| lineTotal <br /> *read-only*   | Total of quantity multiplied by unit price.  <br /> *float* |
| usage <br /> *read-only*       | If this is a usage charge. <br /> *boolean*                 |
...
```json 
{
  "type": "customerlimits",
  "id": "99999",
  "uri": "https://pbx.sipcentric.com/api/v1/customers/99999/limits",
  "parent": "https://pbx.sipcentric.com/api/v1/customers/99999",
  "phone": 50,
  "group": 10,
  "queue": 10,
...
| parent <br /> *read-only*  | URI of this customer account. <br /> *String*        |
| phone <br /> *read-only*   | Limit of extensions. <br /> *integer*                |
| group <br /> *read-only*   | Limit of groups. <br /> *integer*                    |
| queue <br /> *read-only*   | Limit of queues. <br /> *integer*                    |
| ivr <br /> *read-only*     | Limit of ivrs. <br /> *integer*                      |
| mailbox <br /> *read-only* | Limit of shared mailboxes. <br /> *integer*          |
| did <br /> *read-only*     | Limit of incoming numbers. <br /> *integer*          |
| channel <br /> *read-only* | Channel limit. <br /> *integer*                      |
...
```
GET https://pbx.sipcentric.com/api/v1/customers/99999/limits
```
...
```json 
{
  ...
  "id": "99999",
  "uri": "https://pbx.sipcentric.com/api/v1/customers/99999/pricing",
  "parent": "https://pbx.sipcentric.com/api/v1/customers/99999",
  "phone": 2.00,
  "virtual": 0.10,
  "group": 4.00,
...
| parent <br /> *read-only*  | URI of this customer account. <br /> *String*          |
| phone <br /> *read-only*   | Price per extension. <br /> *float*                    |
| group <br /> *read-only*   | Price per ring group. <br /> *float*                   |
| queue <br /> *read-only*   | Price per call queue. <br /> *float*                   |
| ivr <br /> *read-only*     | Price per IVR. <br /> *float*                          |
| mailbox <br /> *read-only* | Price per shared mailbox. <br /> *float*               |
| did <br /> *read-only*     | Price per incoming number. <br /> *float*              |
...
```
GET https://pbx.sipcentric.com/api/v1/customers/99999/pricing
```
...
```json
{
  "type": "linkeduser",
  "id": "35180",
  "uri": "https://pbx.sipcentric.com/api/v1/customers/99999/linkedusers/35180",
...
| created <br /> *read-only*         | Timestamp for this user's creation. <br /> *date*              |
| userId <br /> *read-only*          | ID for this user. <br /> *string*                              |
| email <br /> *read-only*           | Email for this user. <br /> *string*                           |
| username <br /> *read-only*        | Username for this user. <br /> *string*                        |
| accessLevel <br /> *read-only*     | This user's access level. <br /> *string*                      |
| enabled <br /> *read-only*         | Whether the user is enabled or not. <br /> *bolean*            |
| pending <br /> *read-only*         | If the user is still pending activation. <br /> *float*        |
| acceptedInvite <br /> *read-only*  | If the user has accepted the invitation or not. <br /> *float* |
| owner <br /> *read-only*           | Whether this user is the account owner. <br /> *float*         |
| recordingAccess <br /> *read-only* | Level of call recording access. <br /> *float*                 |
...
```
GET https://pbx.sipcentric.com/api/v1/customers/99999/linkedusers
```
...
```
GET https://pbx.sipcentric.com/api/v1/customers/99999/linkedusers/35180
```
...
```
GET https://pbx.sipcentric.com/api/v1/customers/99999/linkedusers/me
```
...
| domainCostMinute <br /> *required* | Per minute cost for on-net calls. <br /> *float*          |
| roundSeconds <br /> *requried*     | How many seconds the call rounds to. <br /> *integer*     |
| minDuration <br /> *read-only*     | The minimum duration for calls. <br /> *integer*          |
| minCharge <br /> *read-only*       | Minimum call charge.  <br /> *float*                      |
...

{
  "type": "chargingplan",
  "id": "999",
  "uri": "https://pbx.sipcentric.com/api/v1/chargingplans/999",
  "name": "Test Chargingplan",
  "currency": "GBP",
  "domainCostMinute": 0.000,
  "roundSeconds": 1,
  "minDuration": 20,
...
```
https://pbx.sipcentric.com/api/v1/customers/99999/recordings/242348.wav?tokenid=318f9a6d-162e-4d46-89d2-3d7cb2f4db16
```
