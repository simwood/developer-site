...
The billing  sub-resource returns the current billing configuration and pricing plan for an different features, represented by a `billing` instance.
...
**Explantion**
The above result shows us that we have received  5 calls and made 6 calls. You can also see that charles received 1 call and made 5 calls.
